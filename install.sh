...
DARWIN_MD5="26a3f1b7e40078aaf12de1f71c6bed03"
...
REMOTE_DARWIN_TARBALL="https://github.com/aydoganersoz/tomat/releases/download/$TOMAT_VER/tomat-$TOMAT_VER-darwin-amd64.tar.gz"

echo "Setting up tomat..."
if [[ "$OSTYPE" == darwin* ]] ; then {
    curl -L -o $DOWNLOADED_TARBALL $REMOTE_DARWIN_TARBALL && \
    [[ $(md5 -r $DOWNLOADED_TARBALL) == $DARWIN_MD5 ]] && \
